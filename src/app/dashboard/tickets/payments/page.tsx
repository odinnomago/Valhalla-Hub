  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold">Configurar Pagamentos</h1>
          <p className="text-muted-foreground">Gerencie as formas de pagamento para seus ingressos</p>
        </div>
